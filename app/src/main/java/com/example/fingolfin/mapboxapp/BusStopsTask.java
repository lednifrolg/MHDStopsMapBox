 ...
 */
public class BusStopsTask extends AsyncTask<MapView, Void, Boolean> {

    public static String TAG = BusStopsTask.class.getSimpleName();
    ...
    public void updateStops(JSONObject jObj) {
        ...
        Drawable drawable = ContextCompat.getDrawable(mContext, R.drawable.ic_directions_bus_black_18dp);
    ...
    private JSONObject getJson() {
        ...
        try {
            URL url = new URL(NetworkInfo.IP_ADDRESS + "/bus.php");
